defmodule RestAPI.Router.Route do
  ...
  defp build_params() do
    ...
    merge_params =
      quote(do: RestAPI.Router.Route.merge_params(unquote(params), unquote(path_params)))
